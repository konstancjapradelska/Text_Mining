...
data_zad2 = {'Token': most_common_tokens, 'Występowanie': token_occurrences_amount}
data_zad2 = pd.DataFrame(data_zad2)
print("Zadanie 2:\n", pd.DataFrame(data_zad2),"\n")
...
data_zad3 = {'Token': key_tokens, 'Wartość': key_tokens_value}
data_zad3 = pd.DataFrame(data_zad3)
print("Zadanie 3:\n", data_zad3,"\n")
